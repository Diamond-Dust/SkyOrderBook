...
public class EntryPoint
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine($"Data input time per tick [us]: {ms1 * 1000.0 / ts1:F3}");
        // ######### Step 1: Data input #########
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            Console.WriteLine($" OrderBook creation time per tick [us]: {sw2.ElapsedMilliseconds * 1000.0 / sw2.ElapsedTicks:F3}");
        ...
        Console.WriteLine($"Best OrderBook creation time per tick [us]: {ms2 * 1000.0 / ts2:F3}");
        // ######### Step 2: OrderBook construction #########
        ...
        Console.WriteLine($"Result saving time per tick [us]: {ms3 * 1000.0 / ts3:F3}");
        // ######### Step 3: Result saving #########

        long total_ms = ms1 + ms2 + ms3, total_ts = ts1 + ts2 + ts3;
        Console.WriteLine($"Best total time [us]: {total_ms * 1000.0:F3}");
        Console.WriteLine($"Best total time per tick [us]: {total_ms * 1000.0 / total_ts:F3}");
    }
}